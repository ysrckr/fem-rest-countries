...
export const Input = ({ icon, ...props }: InputProps) => {
  return (
    <div className="flex w-full max-w-md items-center rounded-md border border-gray-300 shadow-md dark:border-dark-element dark:bg-dark-element dark:text-white">
